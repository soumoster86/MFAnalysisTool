"""Alert / notification and user rule ORM models (Slice B).

Self-contained — only depends on database.session.Base.
Do NOT import from services.* here (causes Streamlit Cloud circular ImportError).
"""
